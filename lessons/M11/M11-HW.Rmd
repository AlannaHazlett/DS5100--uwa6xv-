...
# Student Info
    ...
    Name: Alanna Hazlett 
    Net ID: uwa6xv
    File GitHub URL: https://github.com/AlannaHazlett/DS5100--uwa6xv-/tree/main/lessons/M11
...
```{r}
Data<- read.csv(url("https://archive.ics.uci.edu/ml/machine-learning-databases/abalone/abalone.data")
                ,header=FALSE)
```
